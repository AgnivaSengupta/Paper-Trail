...
const BlogLayout = ({ children }: Props) => {
  const { authFormOpen, setAuthFormOpen, authType, setAuthType } = useAuthStore();
  ...
  return (
    ...
    <div className="min-h-screen bg-background">
      ...
      <Authform open={authFormOpen} onOpenChange={setAuthFormOpen} authType={ authType } setAuthType={setAuthType} />
    </div>
  );
};
