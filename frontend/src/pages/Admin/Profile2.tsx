          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 animate-fade-in">
                ...
                <div className="relative group">
                  ...
                  <Avatar className="w-24 h-24 ring-4 ring-background shadow-lg relative transition-transform duration-300 group-hover:scale-105">
                    <AvatarImage
                      ...
                      className="object-cover"
                    />
                    <AvatarFallback className="text-2xl font-serif bg-muted">
                      AS
                    </AvatarFallback>
                  </Avatar>
                </div>
              ...
              <div className="flex gap-3">
                ...
                <Button
                  size="sm"
                  className="gap-2 translate-y-4.5 cursor-pointer"
                >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <a
                        href="mailto:agniva@example.com"
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-9 w-9 hover:text-foreground hover:bg-muted"
                        >
