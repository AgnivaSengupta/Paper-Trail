...
const BlogTableRow = ({
  ...
  return (
    <div
      className="w-auto h-36 border-b-1 border-gray-500 flex items-center gap-5 px-5 py-2 hover:bg-white/5 cursor-pointer"
    ...
    >
      ...
      <div className="w-full h-25 flex flex-col justify-between p-2">
        ...
        <div className="flex gap-5">
          <div className="flex justify-center items-center text-xs px-2 bg-gray-200/20 rounded-sm text-white shadow-lg">
            Updated 11/09/2025
          </div>
          <Button
            size="sm"
            className="text-xs bg-green-300/10 text-green-500 hover:bg-green-300/10"
          >
            <Eye />
            {views} Views
          </Button>
          <Button
            size="sm"
            className="text-xs bg-red-400/10 text-red-600 hover:bg-red-400/10"
          >
            <Heart />
            {likes} Likes
          </Button>
...
const BlogPosts = () => {
  ...
  return (
    ...
    <Test>
      <div
        className="flex justify-between pl-5 pr-10"
        onClick={() => navigate("/admin/create")}
      >
        <h1 className="text-xl">Blog Posts</h1>
